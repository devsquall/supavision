...
def load_template(
    ...
    if resource_type == "database" and effective_type == "database":
        logger.warning(
            "Using generic database template. Set config.db_engine to "
            "'postgresql' or 'mysql' for engine-specific health checks."
        )
