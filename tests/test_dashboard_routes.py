...
from supavision.models import Finding, FindingSeverity, Resource, User
...
def _seed_finding(store: Store, resource_id: str) -> Finding:
    """Create and persist a test finding."""
    f = Finding(
